...
:root {
    --bg-dark: #000000; /* Updated for pure black background */
    --bg-secondary: #111111; /* Slightly lighter black for contrast */
    --bg-card: #1a1a1a; /* Darker card background */
    --text-primary: #00ff37; /* Bright green for primary text */
    --text-secondary: #00cc2e; /* Slightly muted green for secondary text */
    --text-muted: #009922; /* Even more muted green */
    --primary-color: #00ff37; /* Bright green for accents */
    --primary-hover: #00e636; /* Slightly darker green for hover effects */
    --error-color: #ff3333; /* Red for error messages */
    --success-color: #00cc44; /* Green for success messages */
    --link-color: #00ff55; /* Slightly lighter green for links */
    --link-hover: #00e64d; /* Hover effect for links */
